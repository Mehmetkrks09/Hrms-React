...
export default function CvAdd() {
  ...
  useEffect(() => {
   let departmentService=new DepartmentService();
    ...
    departmentService.getDepartment().then((result) => setDepartment(result.data.data));
    foreignLanguageService.getAll ().then((result) => setForeignLanguage(result.data.data));
         schoolService.getAll().then((result) =>setSchool(result.data.data));
    jobExperienceService.getAll().then((result) => setJobExperience(result.data.data));
  }, []);
  ...
  const foreignLanguageOption = foreignLanguages.map((foreignLanguage, index) => ({
    key: index,
      ...
      <Form onSubmit={formik.handleSubmit}>
        ...
        <Dropdown
          ...
          <label>iş Deneyimi</label>
                ...
                />
                {formik.errors.jobExperienceId && formik.touched.jobExperienceId && (
                  <div className={"ui pointing red basic label"}>{formik.errors.jobExperienceId}</div>
                )}
              </Form.Field>
              <Form.Field>
